...
public final class ShopitemBinding implements ViewBinding {
  ...
  private ShopitemBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivLike,
  ...
  public static ShopitemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.shopitem, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ShopitemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ShopitemBinding((LinearLayout) rootView, ivLike, ivSkShopIcon, ivStar,
